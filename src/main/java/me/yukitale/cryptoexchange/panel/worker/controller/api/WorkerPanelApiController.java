...
public class WorkerPanelApiController {
    ...
    public ResponseEntity<String> legalsController(Authentication authentication, @RequestBody Map<String, Object> data) {
        ...
        if (!type.equals("AML") && !type.equals("TERMS")) {
        ...
        Worker worker = workerService.getWorker(authentication);
        String cooldownKey = worker.getId() + "-edit-" + type;
        ...
        WorkerLegalSettings workerLegalSettings = workerLegalSettingsRepository.findByWorkerId(worker.getId()).orElseThrow(() -> new RuntimeException("Worker legal settings not found for worker " + worker.getUser().getEmail()));
